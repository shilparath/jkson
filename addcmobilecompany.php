				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Product Company</h5>
						</div>
						<!-- Breadcrumb -->
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="row">
											<div class="col-sm-12 col-xs-12">
												<div class="form-wrap">
														...
														<div class="form-body">
															<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>Add Company</h6>
															...
															<div class="col-md-12">
																<div class="col-md-6">
																	<div class="form-group ">
																		...
																		<input type="text"  name="mobilecompany"  class="form-control"  placeholder="Enter Company Name">
										...
										if(isset($_POST['save_color'])){
											$companyname = $_POST['mobilecompany'];
											//$color = $_POST['mobilecolor'];
											$sql = mysqli_query($con,"INSERT INTO `mobilecompany`(`name`) VALUES ('$companyname')");
										...
										while($rowdata = mysqli_fetch_assoc($sql)){
											?>
												...
												<tr>
													...
													<td width="25%" style="height: 30px"><a href="editmcompanyr.php?name=<?php echo($rowdata['id']) ?>"><i class="fa fa-edit"></i></a></td>
													<td width="25%" style="height: 30px"><a href="deletemcompany.php?name=<?php echo($rowdata['id']) ?>" style="color: red"><i class="fa fa-remove"></i></a></td>
												</tr>
