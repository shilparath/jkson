															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		...
																		<input type="text" name="client_details" class="form-control" placeholder="Client Name" >
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
												...
												<div class="form-wrap">
														...
														<div class="form-body">
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		<label class="control-label mb-10">Existing Buyer Name</label>
																		<select name="customer_details" class="form-control" >
                                      <option value="0" selected>Select Supplier</option>
                                      <?php $fetchBuyer = fetchParty();
																			foreach ($fetchBuyer as $v1) { ?>
                                      ...
                                      <?php }?>
																...
																<div class="col-md-6">
																	<div class="form-group ">
																		<label class="control-label mb-10">Your P.O No</label>
																		<input type="text"  name="po_no"  class="form-control"  placeholder="Your P.O. Number">
																		<span class="help-block">  </span>
																	</div>
																</div>
														...
														<div class="row">
																...
																<div class="col-md-6">
																	<div class="form-group ">
																		<label class="control-label mb-10">New Buyer Name</label>
																		<input type="text"  name="new_customer"  class="form-control"  placeholder="New Buyer Number">
																		<span class="help-block">  </span>
																	</div>
																</div>
																...
																<div class="col-sm-6">
																	<div class="form-group">
																		<label class="control-label mb-10">Date</label>
																			<input placeholder="Today's Date" onfocus="(this.type='date')" onblur="(this.type='text')" name="date" class="form-control"  placeholder="Enter Date & Time" value="<?php echo date('Y-m-d'); ?>"/>
																		</div>
																	</div>
																</div>
															...
															<div class="row">
																...
																<div class="col-md-6">
																	<div class="form-group ">
																		<label class="control-label mb-10">Offer No</label>
																		<input type="text" name="offer_no"  id="place_of_supply" class="form-control" placeholder="Order No">
																		<span class="help-block">  </span>
																	</div>
																</div>
															</div>
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group ">
																		<label class="control-label mb-10">Buyer Invoice No</label>
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group ">
																		...
																		<input placeholder="Invoice Date" onfocus="(this.type='date')" onblur="(this.type='text')" name="invoice_date" class="form-control"  placeholder="Enter Date & Time" value="<?php echo date('Y-m-d'); ?>"/>
																		<span class="help-block">  </span>
																	</div>
																</div>
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group ">
																		...
																		<input type="text" name="challan_no"  class="form-control" placeholder="Our Challan No">
																		<span class="help-block">  </span>
																	</div>
																</div>
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group ">
																		<label class="control-label mb-10">Challan Date</label>
																		<input placeholder="Challan's Date" onfocus="(this.type='date')" onblur="(this.type='text')" name="challan_date" class="form-control"  placeholder="Enter Date & Time" value="<?php echo date('Y-m-d'); ?>"/>
																		<span class="help-block">  </span>
																	</div>
																</div>
														</div>
										...
										<div class="table-wrap">
											<table id="POITable"  data-toggle="table"  >
												...
												<tbody >
													...
													<td>
														<span style="color:#fff;">SGST:</span><br><input type="text" style="width:60px;background-color: #212121;color:#fff;" name="sgst[]" class="sgst_cls"  id="sgst-0" readonly>
...
<?php } ?>
 SL No</label>
																		<input type="text"  name="job_no"  class="form-control"  placeholder="Job Sl Number">
																		<span class="help-block">  </span>
																	</div>
																</div>
														...
														<div class="row">
															...
															<div class="row">
																	...
																	<div class="form-group ">
																		<label class="control-label mb-10">Quotation No</label>
																		<input type="text" name="quotation_no"  class="form-control" placeholder="Qutation No>
																		<span class="help-block">  </span>
																	</div>
																</div>
