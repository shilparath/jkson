...
function fetchSellItems(){
  ...
  $stmt = $mysqli->prepare("SELECT
    ...
    FROM sellItems
    INNER JOIN insertProduct ON sellitems_without_gst.mat_des = insertProduct.id
    GROUP BY bill
    ");
    $stmt->execute();
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
                          ...
                          $i = 1;
                          $sql = mysqli_query($con,"SELECT * FROM `sellitems_without_gst` WHERE 1 GROUP BY `bill`");
				 		while($v1 = mysqli_fetch_assoc($sql)){
                           ...
                           ?>
													<tr>
														...
														<td>
															<a href="customer-invoice1_without_gst.php?printid=<?php echo $v1['bill']; ?>" target="_blank">
