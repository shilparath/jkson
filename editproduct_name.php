					...
					<div class="row heading-bg">
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							...
							<li class="active"><span>Edit Product Name</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
										...
										<div class="row">
											<div class="col-sm-12 col-xs-12">
												<div class="form-wrap">
														...
														<div class="form-body">
															<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>Edit Product Name</h6>
															<hr class="light-grey-hr"/>
															<?php
															$id1 = $_GET['id'];
															$sql1 = mysqli_query($con,"SELECT * FROM `product_name` WHERE `id`='$id1'");
															...
															<div class="col-md-12">
																		...
																		<select name="companyname" class="form-control" >
                                     										 <option value="" selected disabled>Select Company name</option>
																				...
																				while($rowdata = mysqli_fetch_assoc($sql)){
																					?>
																					<option value="<?php echo($rowdata['id']) ?>"selected><?php echo($rowdata['name']) ?></option>
																...
																<div class="col-md-6">
																	...
																	<input type="hidden" name="id" value="<?php echo($id) ?>">
																		...
																		<input type="text"  name="product_name"  class="form-control"  placeholder="product name" value="<?php echo($rowdata1['name']) ?>">
																		<span class="help-block">  </span>
																	</div>
																</div>
															</div>
															<?php
																...
																<div class="form-actions mt-10">
																	<button type="submit" class="btn btn-success  mr-10" name="update_company"> Update</button>
...
if(isset($_POST['update_company'])){
	$id = $_POST['id'];
	$name = $_POST['mobilecompany'];
	$sql = mysqli_query($con,"UPDATE `mobilecompany` SET `name`='$name' WHERE `id`='$id'");
