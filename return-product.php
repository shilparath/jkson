									...
									<div class="panel-body">
										...
										if(isset($_POST['save_color'])){
											...
											if($returntype=="replace"){
												   ...
												   $sql2 = mysqli_query($con,"UPDATE `stockdetails` SET `quantity`=$quantity2 WHERE `id`=$productname");
                                                  
											}else{
										
										
											$damaged = $rowdata['damaged'];
                                             $damaged2 = $damaged+$amount;
										 	$sql3 = mysqli_query($con,"UPDATE `stockdetails` SET `damaged`=$damaged2 WHERE `id`=$productname");
