                  ...
                  <table width="100%" id="data_table_add_product">
                    ...
                    <tbody >
                      <tr class="table-align" id="data_table_td_0">
                        ...
                        <td><input type="text" style="width:50px;background-color: #212121;color:#fff;"   class="discount_cls"  id="discount-0" name='discount[]'></td>
              ...
              if (event.which == '10' || event.which == '13') {
				...
				function totalAmount2(i,j)
				{
					...
					$(document).on('keyup', '.discount_cls', function(){
									...
									var z = days_last ;
									var discount = parseFloat($("#discount-"+i).val());
									var amount = $('#amount-'+days_last).val();
									var discountamount = (parseFloat(amount)*parseFloat(discount))/100;
									var final_amount = parseFloat(amount)-parseFloat(discountamount);
									$('#tax_cost-'+days_last).val(final_amount);
									var finalAmount = 0;
									for(var i=0;i<=z;i++) {
