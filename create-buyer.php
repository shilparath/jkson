				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-dark">Add Suplier's</h5>
						</div>
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="firstName" class="form-control"  placeholder="Supplier's Name">
      ...
      frm.submit(function (e) {
          ...
          $.ajax({
              ...
              success: function (data) {
                  swal("Good job!", "Buyer is Successfully Created!!", "success")
