		...
		<?php include("include/top_nav.php"); ?>
			...
			<div class="page-wrapper">
				<div class="container-fluid">
					...
					<!-- /Title -->
					<form method="post" id="tax_invoice" action="submit_material_list_without_gst.php" name="bill_master" id="billform">
					<div class="row">
						<div class="col-md-12">
											...
											<div class="col-sm-12 col-xs-12">
												<div class="form-wrap">
														...
														<div class="row">
																...
																<?php
																	$sql1 = mysqli_query($con,"SELECT `invoice_no` FROM `sellitems_without_gst` ORDER BY `id` DESC LIMIT 1");
																	if($sql1->num_rows=="0"){
																		$invoiceno = 1000;
																	}else{
