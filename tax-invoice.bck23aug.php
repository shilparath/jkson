		...
		<?php include("include/top_nav.php"); ?>
			...
			<div class="page-wrapper">
				<div class="container-fluid">
					...
					<!-- /Title -->
					<form method="post" id="tax_invoice" action="submit_material_list.php" name="bill_master" id="billform">
					<div class="row">
						<div class="col-md-12">
														...
														<div class="row">
																...
																<div class="col-md-6">
																	<div class="form-group ">
																		...
																		<input type="text" name="code" class="form-control" placeholder="Enter Customer Mobile No" required>
																		<span class="help-block">  </span>
																	</div>
																</div>
															</div>
                        ...
                        <th style="text-align: center">Model No</th>
												...
												<tbody >
													...
													<!-- <td><select type='text' style='width:150px;background-color: #212121;color:#fff;' id="mat_des-0" name="mat_des[]" class="mat_des_clss required">
														...
														<option value="<?php //echo $v1['id']."///".$v1['mat_code'];?>"><?php //echo $v1['mat_code']."/".$v1['mat_des'];?></option><?php// } ?>
													</select></td> -->
						...
						<td><select style="width:90px;background-color: #212121;color:#fff;" name="product_name[]" id="product_name-0" class="product_name_clss"></select></td>
                        ...
                        <td><select style="width:90px;background-color: #212121;color:#fff;" name="mat_des[]" class="mat_des_clss" id="mat_des-0">
													...
													<td><span style="color:#fff;">Base Price:</span><br><input type="text" style="width:60px;background-color: #212121;color:#fff;" name="purchase_rate[]" class="purchase_rate_cls"  id="purchase_rate-0" readonly><br>
														  <span style="color:#fff;">Tax Price:</span><br><input type="text" style="width:60px;background-color: #212121;color:#fff;" name="tax_amount[]" class="purchase_tax_cls"  id="purchase_tax-0" readonly><br>
													...
													<td>
														<span style="color:#fff;">SGST:</span><br><input type="text" style="width:60px;background-color: #212121;color:#fff;" name="sgst[]" class="sgst_cls"  id="sgst-0" readonly><br>
														<span style="color:#fff;">CGST:</span><br><input type="text" style="width:60px;background-color: #212121;color:#fff;"name="cgst[]" class="cgst_cls"  id="cgst-0" readonly><br>
														<span style="color:#fff;">IGST:</span><br><input type="text" style="width:60px;background-color: #212121;color:#fff;"name="igst[]" class="igst_cls"  id="igst-0" readonly></td>
